...
<div class="row">
  <div class="col-12 col-lg-8 col-xl-9 px-2">
    <!-- Row 1 New Call Log Form -->
    <div class="row mx-0">
      <div class="col-12 mb-3 p-3 bg-white">
        <div class="col-12-center titleBottomBorder">
          <p><i class="fas fa-thumbtack"></i> <strong>New Call Log</strong></p>
        </div>
        <div class="col-12 col-xl-10 px-0 py-4">
          <form class="needs-validation" method="POST" action="{{ route('call.store') }}" id="callform">
            @csrf

            <div class="form-row">
              <div class="col-md-4 mb-3">
                <label for="callID">Call Log ID</label>
                <input disabled="" type="text" class="form-control" value="A00{{ $newid }}">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="invalid-feedback">Please enter call log subject</div>
            </div>
            <div class="form-group">
              <label for="description"><sup>*</sup> Description</label>
              <textarea class="form-control" id="description" rows="6" placeholder="Enter call details" name="description" required></textarea>
              <div class="invalid-feedback">Please enter call log description</div>
            </div>
            <div class="form-row">
              <div class="col-md-6 mb-3">
                <label for="contactName"><sup>*</sup> Contact Name</label>
                <input type="text" class="form-control" id="contactName" placeholder="Enter contact name" name="contact_name" required>
                <div class="invalid-feedback">Please enter contact person</div>
              </div>
              <div class="col-md-6 mb-3">
                <label for="tel"><sup>*</sup> Telephone</label>
                <input type="number" class="form-control" id="tel" placeholder="Enter telephone" name="contact_no" required>
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" id="remarks" placeholder="Enter task remarks" rows="6" name="remarks"></textarea>
