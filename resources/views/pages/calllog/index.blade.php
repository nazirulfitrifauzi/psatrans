...
<div class="row">
    ...
    <div class="row mx-0">
      <div class="col-12 mb-3 p-3 bg-white">
        <div class="col-12-center titleBottomBorder">
          <p><i class="fas fa-thumbtack"></i> <strong>Call Log List</strong></p>
        </div>
  ...
  $(document).ready(function() {
    $('#destination_table').DataTable({
      "processing": true,
      "serverSide": false,
      "ajax": "{{ route('ajaxdata.getdatacall') }}",
      "columns":[
          { "data": "id" },
          { "data": "datetime" },
          ...
          { render:function(data, type, row){
              return "<a href='call/"+ row.id +"'><i class='fas fa-edit float-right'></i></a>"
      ...
      "language": {"searchPlaceholder": "Call Log Id"}
    });
  });
  </script>
  </body>
