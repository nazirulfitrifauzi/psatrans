    ...
    <div class="row mx-0">
      <div class="col-12 mb-3 p-3 bg-white">
        <div class="col-12-center titleBottomBorder">
          <p><i class="fas fa-thumbtack"></i> <strong>New Task Update</strong></p>
        </div>

        <div class="col-12 col-xl-10 px-0 py-4">
          <form class="needs-validation" method="POST" action="{{ route('task.store') }}" id="taskform">
            @csrf
            <div class="form-row">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" id="description" rows="6" placeholder="Enter task details" name="description" required></textarea>
              <div class="invalid-feedback">Please enter task description</div>
            </div>
            <div class="form-row">
              <div class="col-md-4 mb-3">
                <label for="requester">Requester</label>
                <input readonly type="text" class="form-control" id="requester" name="request_by" value="{{ Auth::user()->username }}">
              </div>
              <div class="col-md-4 mb-3">
            ...
            <a class="btn btn-success col-5 col-md-2 mt-4" href="{{ route('task.index') }}" role="button"><i class="fas fa-redo-alt"></i> Cancel</a>
          </form>
        </div>
      </div>
    </div>
