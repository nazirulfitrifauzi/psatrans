...
<!-- Left Navigation Menu -->
  ...
  <!-- Notification -->
    ...
    <div class="row">
      ...
      @endif
      <div class="col-xl-4 col-lg-6 col-md-12 px-2">
        <div class="col-12 p-3 bg-white">
          <p><i class="fas fa-box-open"></i> <strong>Consignment HQ</strong></p>
          <table id="consignment_table" class="table table-sm table-striped">
            <thead>
              <tr>
                <th class="align-top" scope="col" width="25%">Date <i class="fas fa-sort"></i></th>
                <th class="align-top" scope="col" width="16%">Time <i class="fas fa-sort"></i></th>
                <th class="align-top" scope="col" width="15%">CN No</th>
                <th class="align-top" scope="col" width="18%">Shipper</th>
                <th class="align-top" scope="col" width="18%">Des</th>
                <th class="align-top" scope="col" width="8%"></th>
              </tr>
            </thead>
            <tbody>
              @forelse ($hqlist as $row)
                  <tr>
                    <form class="col-md-12" action="dashboard/consignmentHQ/{{ $row->id }}" method="post">
                      ...
                      <td align="center">{{ date_format($row['cn_datetime'], "g:ia") }}</td>
                      <td>
                        {{ $row['cn_no'] }}
          ...
          <p class="text-right"><a href="{{ route('dashboard.consignmentHQ') }}">Full List</a></p>
        </div>
        <!-- Row 2 Consignment SOUTH: Display 8 rows -->
        <div class="col-12 p-3 my-3 bg-white">
          <p><i class="fas fa-box-open"></i> <strong>Consignment SOUTH</strong></p>
          <table id="consignmentSouth_table"  class="table table-sm table-striped">
            <thead>
              <tr>
                <th class="align-top" scope="col" width="25%">Date <i class="fas fa-sort"></i></th>
                <th class="align-top" scope="col" width="17%">Time</th>
                <th class="align-top" scope="col" width="18%">CN No</th>
                <th class="align-top" scope="col" width="20%">Shipper</th>
                <th class="align-top" scope="col" width="20%">Des</th>
              </tr>
            </thead>
          </table>
          <p class="text-right"><a href="{{ route('dashboard.consignmentSouth') }}">Full List</a></p>
        </div>
        <!-- Row 3 Consignment NORTH: Display 8 rows -->
        <div class="col-12 p-3 my-3 bg-white">
          <p><i class="fas fa-box-open"></i> <strong>Consignment NORTH</strong></p>
          <table id="consignmentNorth_table" class="table table-sm table-striped">
            <thead>
              <tr>
                <th class="align-top" scope="col" width="25%">Date <i class="fas fa-sort"></i></th>
                <th class="align-top" scope="col" width="17%">Time</th>
          ...
          <p class="text-right"><a href="{{ route('dashboard.consignmentNorth') }}">Full List</a></p>
        </div>
      </div>
      <!-- Column 2 -->
      <!-- Row 1 Consignment Out for Delivery for Driver Only -->
      <div class="col-xl-5 col-lg-6 col-md-12 px-2">
        <div class="row mx-0">
          <div class="col-12 p-3 bg-white">
            <p class="titleBottomBorder"><i class="fas fa-user-circle"></i> <strong>Consignment Out for Delivery (Driver)</strong></p>
          </div>
        </div>
        <form target="_blank" method="POST" action="{{ route('driverOFD.download') }}">
          @csrf
          <div class="row mx-0 bg-white">
            <div class="col-12 col-sm-6 py-1">
              <select name="driver_name" id="driver_name" class="custom-select custom-select-sm">
          ...
          <div class="row mx-0 bg-white">
            <div class="col-12 col-sm-6 py-2">
              <div class="input-group date" id="date_from" data-target-input="nearest">
                <input name="date_from" type="text" class="form-control datetimepicker-input" data-target="#date_from" placeholder="Start Date">
            ...
            <div class="col-12 col-sm-6 py-2">
              <div class="input-group date" id="date_to" data-target-input="nearest">
                <input name="date_to" type="text" class="form-control datetimepicker-input" data-target="#date_to" placeholder="End Date">
        ...
        <!-- Row 2 Consignment Out for Delivery List: Display 19 rows -->
        <div class="col-12 p-3 my-3 bg-white">
          <p><i class="fas fa-truck-moving"></i> <strong>Consignment Out for Delivery</strong> </p>
          <table id="ofd_table" class="table table-sm table-striped">
            <thead>
              <tr>
                <th class="align-top" scope="col" width="20%">Date <i class="fas fa-sort"></i></th>
                <th class="align-top" scope="col" width="15%">CN No</th>
                <th class="align-top" scope="col" width="15%">Shipper</th>
                <th class="align-top" scope="col" width="15%">Des</th>
                <th class="align-top d-none d-sm-table-cell" scope="col" width="17%">Driver</th>
                <th scope="col" width="18%">Status</th>
              </tr>
            </thead>
          </table>
          <p class="text-right"><a href="{{ route('dashboard.outForDelivery') }}">Full List</a></p>
        </div>
      </div>
      <!-- Column 3 -->
      <!-- Row 1 Call List: Display 8 rows -->
      <div class="col-xl-3 col-lg-6 col-md-12 px-2">
        <div class="col-12 p-3 bg-white">
          <p><i class="fas fa-thumbtack"></i> <strong>Task List</strong></p>
          <table id="task_list_table" class="table table-sm table-striped">
            <thead>
              <tr>
                <th class="align-top" scope="col" width="55%">Subject</th>
                <th class="align-top" scope="col" width="18%">Status</th>
                <th class="align-top" scope="col" width="18%">PIC</th>
                <th width="10%"></th>
              </tr>
            </thead>
            <tbody>
              @forelse ($tasklist as $row)
                  <tr>
                    <td>
                      {{ $row['subject'] }}
                    </td>
                    ...
                    <td><a href="task/{{$row->id}}"><i class="fas fa-check-circle"></i></a></td>
                  </tr>
              @empty
                  <tr><td colspan="6" class="text-center">No Record</td></tr>
              @endforelse
          ...
          <p class="text-right"><a href="{{ route('task.index') }}">Full List</a></p>
        </div>
        <!-- Row 2 Task List: Display 8 rows -->
        <div class="col-12 p-3 my-3 bg-white">
          <p><i class="fas fa-thumbtack"></i> <strong>Call Log</strong></p>
          <table id="call_log_table" class="table table-sm table-striped">
            <thead>
              <tr>
                <th class="align-top" scope="col" width="55%">Subject</th>
                <th class="align-top" scope="col" width="18%">Status</th>
            ...
            <tbody>
              @forelse ($calllist as $row)
                  <tr>
                    ...
                    <td><a href="call/{{$row->id}}"><i class="fas fa-check-circle"></i></a></td>
                  </tr>
              @empty
                  <tr><td colspan="6" class="text-center">No Record</td></tr>
              @endforelse
          ...
          <p class="text-right"><a href="{{ route('call.index') }}">Full List</a></p>
        </div>
      </div>
    </div>
    <!-- Footer -->
    ...
    $(document).ready(function() {
      ...
      $('#consignmentSouth_table').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "{{ route('ajaxdata.getdashboard2') }}",
        "columns":[
            { "data": "cn_datetime" },
            { "data": "cn_time", "sortable":false },
            { "data": "cn_no", "sortable":false },
            { "data": "shipper_code", "sortable":false },
            { "data": "destination_code", "sortable":false },
        ],
        "dom": "<'row'<'col-sm-12'tr>>"
      });

      $('#consignmentNorth_table').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "{{ route('ajaxdata.getdashboard3') }}",
        "columns":[
            { "data": "cn_datetime" },
            { "data": "cn_time", "sortable":false },
            { "data": "cn_no", "sortable":false },
      ...
      $('#ofd_table').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "{{ route('ajaxdata.getdashboard4') }}",
        "ordering": false,
        "columns":[
            { "data": "datetime"},
            { "data": "cn_no", "sortable":false},
            { "data": "shipper_code", "sortable":false},
            { "data": "destination_code", "sortable":false},
            { "data": "driver_name", "sortable":false},
